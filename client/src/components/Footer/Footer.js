      ...
      <footer>
         <div className="footer__container">
               ...
               <div className="footer__contact__container">
                  ...
                  <ul className="footer__contacts">
                     <li className="footer__contact">
                        <LocalPhoneIcon /> <span>+91 7874830499</span>
                     </li>
                     <li className="footer__contact">
                        <EmailIcon /> <span>shop@msm.co</span>
                     </li>
                     <li className="footer__contact">
                        <LocationOnIcon /> <span>Surat, Bangalore, Mysore</span>
                     </li>
                  </ul>
               </div>
            ...
            <div className="fotter__copyright__container">
               <ul className="nav">
                  <li className="footer__copyright">©2022 OPMA(CP III) LTD</li>
                  <li className="footer__terms__condition">
                     {' '}
                     | Terms & Condition(NO TERMS) |
                  </li>
